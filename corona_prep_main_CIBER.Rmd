...
author: "Kaisa Saurio, James Twose, Gjalt-Jorn Peters, Matti Heino & Nelli Hankonen"
...
dataPath <- normalizePath(file.path(basePath, "data"));
...
```{r}
write.csv(df_standardized, "figure_data/ciber_data_standardized.csv")
```